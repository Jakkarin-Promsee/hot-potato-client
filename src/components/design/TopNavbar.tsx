...
export default function TopNavbar({
  ...
  const isGroup =
    ...
    (selectedObjects[0] as any)?.type === "group";
    ...
    <header className="h-12 flex items-center justify-between px-4 bg-surface-dark border-b border-toolbar-border shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        {editing ? (
          ...
          <button
            ...
            className="text-surface-dark-foreground text-sm font-medium hover:text-primary-foreground transition-colors"
          >
            {fileName}
          </button>
        )}
      ...
      <div className="flex items-center gap-1">
        ...
        <NavButton
          ...
          title="Zoom Out"
        />
        <span className="text-surface-dark-foreground text-xs w-10 text-center">
          {zoom}%
        </span>
        <NavButton
          icon={ZoomIn}
