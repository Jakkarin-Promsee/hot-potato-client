...
import type { UploadedImage, Category } from "@/types/cloudinary.types";
...
export default function CloudinaryUpload() {
  ...
  const [assigningId, setAssigningId] = useState<string | null>(null); // public_id being reassigned
      ...
      <div className="flex h-[calc(100vh-48px)]">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
            ...
            {/* Error */}
            {error && (
              <div className="rounded-lg bg-red-950/40 border border-red-900/50 px-4 py-2.5 text-[12px] text-red-400">
                ✕ {error}
              </div>
            )}
                    ...
                    >
                      ...
                      {cat && (
                        <div className="absolute top-1 left-1">
                          <span className="text-[9px] px-1.5 py-0.5 rounded bg-black/70 text-violet-300 border border-violet-800/50 truncate max-w-[80px] block">
                            {cat.name}
                          </span>
                        </div>
                      )}
                      ...
                      {assigningId === img.public_id && (
                        <div
                          className="absolute bottom-8 right-1 z-20 bg-zinc-900 border border-zinc-700 rounded-lg shadow-xl p-1.5 min-w-[120px]"
          ...
          {/* ── Detail panel ───────────────────────────────────────────────── */}
          {selectedImage && (
            <aside className="w-72 shrink-0 border-l border-white/[0.06] overflow-y-auto">
